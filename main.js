...
function init() {
    ...
    options.domOverlay = {root: document.getElementById('content')} //everything in content gets displayed while in AR
    ...
    if ( frame ) {
        ...
        if ( hitTestSourceRequested === false ) {
            ...
            session.addEventListener( 'end', function () {
                ...
                // Create smallest possible cube that can contain the shape
